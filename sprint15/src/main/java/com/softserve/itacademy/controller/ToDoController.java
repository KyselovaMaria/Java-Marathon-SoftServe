...
public class ToDoController {
    ...
    public String create(@PathVariable("owner_id") long ownerId, @Validated @ModelAttribute("todo") ToDo todo, BindingResult result) {
        ...
        try {
            ...
            throw new NullEntityReferenceException("Entity was given id=" + ownerId + " references to null!");
        }
        todo.setOwner(owner);
    ...
    public String read(@PathVariable long id, Model model) {
        ToDo todo;
        try {
            todo = todoService.readById(id);
        } catch (NoSuchElementException e) {
            throw new NullEntityReferenceException("Entity was given id=" + id + " references to null!");
        }
    ...
    public String update(@PathVariable("todo_id") long todoId, @PathVariable("owner_id") long ownerId,
        ...
        ToDo oldTodo;
        try {
            oldTodo = todoService.readById(todoId);
        } catch (NoSuchElementException e) {
            throw new EntityNotFoundException("Entity was given id=" + todoId + " was not found!");
        }
    ...
    public String getAll(@PathVariable("user_id") long userId, Model model) {
        ...
        try {
            ...
            throw new EntityNotFoundException("Entity was given id=" + userId + " was not found!");
        }
